    ...
    <tr>
     ...
     <!-- <td>Precio Compra:</td>
      <td> -->
       ...
       <!--  <input type="text" name="precio"  id="precio" class="form-control input-sm" size="3" autocomplete="off" size="30" /></td>
     ...
     <!-- <td><input type="text" name="precioventa" class="form-control input-sm"  id="precioventa" size="3" readonly="readonly"/></td> -->
      <!--  <td><input type="text" name="precioventa" class="form-control input-sm"  id="precioventa" size="3" autocomplete="off" size="30" /></td> -->
   <!--  <td>
...
<!--
 ...
 <!-- <button type="reset" class="btn btn-default" onclick="javascript:location.reload();"><span class="glyphicon glyphicon-edit"></span> Nueva Orden de Compra</button> &nbsp; -->
  ...
  <button type="submit" id="nn" class="btn btn-primary"><span class="glyphicon glyphicon-floppy-saved"></span> Enviar Orden Compra</button></center>
